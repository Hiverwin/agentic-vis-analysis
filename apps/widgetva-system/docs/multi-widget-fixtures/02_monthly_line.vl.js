(() => {
  ...
  return {
    ...
    title: 'Shared Source: Monthly Visitors by Region',
    width: 620,
    height: 340,
    data: { values: buildRows() },
    mark: { type: 'line', point: { filled: true, size: 42 }, tooltip: true },
    encoding: {
      x: { field: 'date', type: 'temporal', timeUnit: 'yearmonth', title: 'Month' },
      y: { field: 'visitors', type: 'quantitative', aggregate: 'sum', title: 'Total visitors' },
      color: { field: 'region', type: 'nominal', title: 'Region' },
      tooltip: [
        { field: 'date', type: 'temporal', timeUnit: 'yearmonth', title: 'Month' },
        { field: 'region', type: 'nominal' },
        { field: 'visitors', type: 'quantitative', aggregate: 'sum', format: ',' },
        { field: 'school_visits', type: 'quantitative', aggregate: 'sum', format: ',' },
      ],
    },
    config: {
      view: { stroke: null },
