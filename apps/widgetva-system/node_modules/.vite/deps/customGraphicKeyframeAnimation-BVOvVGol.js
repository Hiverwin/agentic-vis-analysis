import { $a as mathMin$1, $r as traverseElements, A as isAxisOnBand, Aa as error, Ai as enterEmphasis, Ar as ensureCopyRect, B as IntervalScale, Bi as COMPONENT_MAIN_TYPE_SERIES, Br as isBoundingRectAxisAligned, Bt as normalizeSymbolOffset, C as requireAxisStatistics, Ci as createFromString, Cr as XY, Dn as ComponentModel, E as determineAxisType, Ei as enableComponentHighDownFeatures, En as tokens, Er as clipPointsByRect, F as shouldAxisShow, Fa as MAX_SAFE_INTEGER, Fi as setDefaultStateProxy, G as intervalScaleEnsureValidExtent, Gr as payloadDisableAnimation, Gt as findEventDispatcher, H as ensureValidSplitNumber, Hn as decideCoordSysUsageKind, I as shouldShowAllLabels, Ia as addSafe, In as getLayoutParams, J as isOrdinalScale, Ja as linearMap, Jr as retrieveZInfo, K as isIntervalOrLogScale, Ka as isPositionSizeOptionPercent, L as updateIntervalOrLogScaleForNiceOrAligned, La as asc, Ln as getLayoutRect, Lr as getTransform$1, M as isOnAxisZeroDiscouraged, Mn as createBoxLayoutReference, Mr as expandOrShrinkRect, Ni as leaveEmphasis, Nn as fetchLayoutMode, O as getScaleValuePositionKind, P as retrieveAxisBreaksOption, Pa as warn, Q as getScaleExtentForMappingUnsafe, Qa as mathMax$1, Qi as SINGLE_REFERRING, Qr as transformDirection, R as AXIS_TYPES, Ra as getAcceptableTickPrecision, Ri as toggleHoverEmphasis, Rn as mergeLayoutParam, Rt as createOrUpdatePatternFromDecal, S as registerMetricImpl, Sr as WH, St as registerAction$1, T as createScaleByModel, Ti as SPECIAL_STATES, Tn as makeSeriesEncodeForNameBased, U as getIntervalPrecision, Un as injectCoordSysByOption, Vi as ROAM_ACTION_TYPE_SUFFIX, Vt as normalizeSymbolSize, W as increaseInterval, Wa as isNullableNumberFinite, Wr as mergePath, Xa as mathCeil, Xt as clear, Y as isTimeScale, Ya as mathAbs, Yi as makeStyleMapper, Yr as setTooltipConfig, Za as mathFloor, Zr as subPixelOptimizeLine, Zt as createOrUpdate, _ as associateSeriesWithAxis, _a as makeQueryConditionKindA, _i as Polygon, _n as passesSanitizationFilter, a as parseGeoJSON, ai as removeElement, ao as parsePercent, ar as getScaleBreakHelper, at as prepareSeriesDataSchema, b as eachSeriesDealForAxisStat, ba as parseFinder, bi as Ellipse, bn as retrieveRawValue, br as setLabelStyle, ci as updateProps, co as quantity, di as RadialGradient, do as remRadian, eo as mathPI, et as OrdinalMeta, fi as LinearGradient, fo as round, fr as Model, g as scaleRawExtentInfoEnableBoxCoordSysUsage, gi as Polyline, gn as parseSanitizationFilter, gr as createTextStyle, h as scaleRawExtentInfoCreate, ha as makeInner, hi as Line$1, i as createAxisLabelsComputingContext, ia as defaultEmphasis, j as isNameLocationCenter, ja as log, jr as ensureCopyTransform, k as getTickValueOutermost, kn as applyPreserveAspect, kr as decomposeTransform, lt as DataDiffer, mi as BezierCurve, mo as __extends, n as calcBandWidth, no as nice, o as GeoJSONRegion, oo as parsePositionSizeOption, or as hasBreaks, ot as SeriesData, p as adoptScaleRawExtentInfoAndPrepare, pr as LabelMarginType, q as isLogScale, qa as isRadianAroundZero, qi as getECData, r as AxisTickLabelComputingKind, ri as initProps, rn as SeriesModel, s as GeoSVGRegion, si as saveOldStyle, sn as createTooltipMarkup, st as createDimNameMap, t as Axis, ti as getAnimationConfig, tn as ComponentView, to as mathRound, u as scaleCalcNice, ui as OrientedBoundingRect, ur as getUID, vi as Ring, vr as getLabelStatesModels, w as AxisModelCommonMixin, wr as applyTransform, xi as Circle, ya as normalizeToArray, z as LogScale, zi as getViewOfComponentOrSeries, zr as groupTransition, zt as createSymbol$1 } from "./Axis-BPvfGPOG.js";
import { An as defaults, B as TRANSFORMABLE_PROPS, Bn as isArray, Bt as Point, D as Displayable, En as clone, F as Group, Fn as filter, Ft as boundingRectCalculateTransform, Gt as invert, H as copyTransform, Ht as copy$1, In as find, It as boundingRectContain, Jt as rotate, K as cloneValue, Kn as isNumber, Ln as hasOwn, Lt as boundingRectCopy, Mn as each$1, Nn as eqNaN, Nt as BoundingRect, On as createHashMap, Pn as extend, Pt as boundingRectApplyTransform, Qn as keys, Qt as isMiddleOrRightButtonOnMouseUpDown, Rn as indexOf, Rt as boundingRectCreate, Tn as bind, U as transformableCreate, Un as isFunction, Ut as create, V as Transformable, Vn as isArrayLike, W as transformableGetLocalTransform, Wt as identity, Xt as translate, Yn as isString, Yt as scale, _ as TSpan, _n as normalize, _t as parse, bn as set, c as CompoundPath, cn as copy, cr as retrieve2, dt as fastLerp, en as stop, er as map, f as Rect, fr as trim, g as ZRImage, gn as min, gt as modifyHSL, hn as max, ht as modifyAlpha, in as Eventful, ir as noop, kn as curry, l as ZRText, lr as retrieve3, nr as mergeAll, on as applyTransform$1, or as reduce, qn as isObject$1, qt as mul, rr as mixin, sr as retrieve, tr as merge, vt as parseCssFloat, wn as assert, xn as sub, y as Path, yt as stringify } from "./graphic-Byb0a---.js";
...
function refineAxisBreakChangeEvent(actionResultBatch, payload, ecModel, api) {
	var breaks = [];
	each$1(actionResultBatch, function(actionResult) {
...
function registerAction(registers) {
	...
	function actionHandler(payload, ecModel) {
		...
		function dealUpdate(modelProp, indexProp) {
			each$1(finderResult[modelProp], function(axisModel) {
				each$1(axisModel.updateAxisBreaks(payload).breaks, function(item) {
					var _a;
...
//#endregion
export { collect as $, updateRoamControllerSimply as A, createFloat32Array as At, viewCoordSysGetZoomOption as B, restoreIgnore as Bt, mapSeriesGroupHasOwnGeo as C, Axis2D as Ct, createViewCoordSysSimply as D, warnDeprecated as Dt, createIsInSelfByPointerCheckerEl as E, isEC4CompatibleStyle as Et, getOwnRoamViewCoordSys as F, computeLabelGeometry as Ft, COMPONENT_TYPE_SINGLE_AXIS as G, viewCoordSysSetViewRect as H, isViewCoordSys as I, hideOverlap as It, SingleAxisModel as J, COORD_SYS_TYPE_SINGLE as K, viewCoordSysCopyBoundingRect as L, labelIntersect as Lt, applyViewCoordSysTransToElement as M, Symbol as Mt, calcCompensationScaleToPreserveNodeSize as N, getDefaultInterpolatedLabel as Nt, isRoamPayloadHasZoom as O, isCoordinateSystemType as Ot, clampByZoomLimit as P, getDefaultLabel as Pt, AxisView as Q, viewCoordSysCopyOverallMatrix as R, labelLayoutApplyTranslation as Rt, getMainMapSeries as S, registerAxisBreakHelperImpl as St, MapDraw as T, convertToEC4StyleForCustomSerise as Tt, RoamController as U, viewCoordSysSetBoundingRect as V, shiftLayoutOnXY as Vt, install$2 as W, rectCoordAxisBuildSplitArea as X, install$3 as Y, rectCoordAxisHandleRemove as Z, ECLinePath as _, AXIS_BREAK_COLLAPSE_ACTION_TYPE as _t, isTransitionAll as a, COORD_SYS_TYPE_CARTESIAN_2D as at, MapSeries as b, registerAction as bt, makeLinearBrushOtherExtent as c, requireAxisStatisticsForBaseBar as ct, BrushController as d, makeAxisStatKey as dt, getAxisInfo as et, sliderMove as f, makeAxisStatKey2 as ft, Line as g, AxisBuilder as gt, LineDraw as h, layout as ht, applyUpdateTransition as i, createSeriesDataSimply as it, View as j, SymbolDraw as jt, registerRoamActionSimply as k, isGeoLikeCoordSys as kt, makeRectIsTargetByCursor as l, createBandWidthBasedAxisContainShapeHandler as lt, injectThumbnailBridge as m, isCartesian2DInjectedAsDataCoordSys as mt, stopPreviousKeyframeAnimationAndRestore as n, registerLegacyGridContainLabelImpl as nt, updateLeaveTo as o, SERIES_TYPE_PICTORIAL_BAR as ot, getThumbnailBridge as p, getCartesianAxisHashKey as pt, COORD_SYS_TYPE_SINGLE_AXIS_COMPATIBLE as q, applyLeaveTransition as r, axisModelCreator as rt, install as s, getStartValue as st, applyKeyframeAnimation as t, makeKey as tt, makeRectPanelClipPath as u, createMetricsNonOrdinalLinearPositiveMinGap as ut, VisualMapping as v, AXIS_BREAK_EXPAND_ACTION_TYPE as vt, mapSeriesNeedsDrawMap as w, convertFromEC4CompatibleStyle as wt, buildAllMapSeriesGroups as x, getAxisBreakHelper as xt, install$1 as y, AXIS_BREAK_TOGGLE_ACTION_TYPE as yt, viewCoordSysCopyTrans as z, newLabelLayoutWithGeometry as zt };

//# sourceMappingURL=customGraphicKeyframeAnimation-BVOvVGol.js.map