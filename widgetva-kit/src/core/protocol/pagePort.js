...
export const PAGE_PORT_ALIASES = {
  ...
  agent_turn_run: 'runAgentTurn',
  agent_session_run: 'runAgentSession',
  widget_adapter_list: 'listWidgetAdapters',
  observation_read: 'readObservation',
  coordination_state_read: 'readCoordinationState',
  shared_analytical_state_read: 'readSharedAnalyticalState',
  shared_filter_context_read: 'readSharedFilterContext',
  shared_viewport_context_read: 'readSharedViewportContext',
  shared_semantic_focus_read: 'readSharedSemanticFocus',
  shared_structural_context_read: 'readSharedStructuralContext',
  shared_view_context_read: 'readSharedViewContext',
  shared_transformation_context_read: 'readSharedTransformationContext',
  active_analytical_context_read: 'readActiveAnalyticalContext',
...
export const PAGE_PORT_METHOD_DESCRIPTORS = {
  ...
  runAgentTurn: makeMethodDescriptor({
    aliases: ['agent_turn_run'],
    description: 'Execute exactly one formal observe-plan-act-verify-reason turn over the current page-port workspace.',
    inputSchema: { type: 'object', additionalProperties: true },
    returns: {
      kind: 'agentTurnRecord',
      description: 'A compact formal turn record with observe, plan, act, verify, and reason.',
      schema: { type: 'object', additionalProperties: true },
    },
  }),
  runAgentSession: makeMethodDescriptor({
    aliases: ['agent_session_run'],
    description: 'Execute a bounded multi-turn formal agent session over the current page-port workspace.',
    inputSchema: { type: 'object', additionalProperties: true },
    returns: {
      kind: 'agentSessionResult',
      description: 'A formal multi-turn session result with knowledge, turns, final answer, and stop reason.',
      schema: { type: 'object', additionalProperties: true },
    },
  }),
  ...
  readSharedAnalyticalState: makeMethodDescriptor({
    aliases: ['shared_analytical_state_read'],
    description: 'Read the canonical workspace-level shared analytical state bundle, including shared filter, viewport, semantic, structural, view, and transformation subcontexts.',
    returns: {
      kind: 'sharedAnalyticalState',
      description: 'A canonical shared analytical state bundle derived from the current workspace state.',
      schema: { type: 'object', additionalProperties: true },
    },
  }),
  readSharedFilterContext: makeMethodDescriptor({
    aliases: ['shared_filter_context_read'],
    description: 'Read only the shared filtering context that later analysis turns should inherit.',
    returns: {
      kind: 'sharedFilterContext',
      description: 'A stable shared filter-context projection derived from the current workspace state.',
      schema: { type: 'object', additionalProperties: true },
    },
  }),
  readSharedViewportContext: makeMethodDescriptor({
    aliases: ['shared_viewport_context_read'],
    description: 'Read only the shared viewport/focus-region context that later analysis turns should inherit.',
    returns: {
      kind: 'sharedViewportContext',
      description: 'A stable shared viewport-context projection derived from the current workspace state.',
      schema: { type: 'object', additionalProperties: true },
    },
  }),
  readSharedSemanticFocus: makeMethodDescriptor({
    aliases: ['shared_semantic_focus_read'],
    description: 'Read only the shared semantic focus context, including focus, primary selection, and highlight summaries.',
    returns: {
      kind: 'sharedSemanticFocus',
      description: 'A stable shared semantic-focus projection derived from the current workspace state.',
      schema: { type: 'object', additionalProperties: true },
    },
  }),
  readSharedStructuralContext: makeMethodDescriptor({
    aliases: ['shared_structural_context_read'],
    description: 'Read only the shared structural context, including link topology, annotations, and comparison targets.',
    returns: {
      kind: 'sharedStructuralContext',
      description: 'A stable shared structural-context projection derived from the current workspace state.',
      schema: { type: 'object', additionalProperties: true },
    },
  }),
  readSharedViewContext: makeMethodDescriptor({
    aliases: ['shared_view_context_read'],
    description: 'Read only the shared view-state summary across widgets.',
    returns: {
      kind: 'sharedViewContext',
      description: 'A stable shared view-context projection derived from the current workspace state.',
      schema: { type: 'object', additionalProperties: true },
    },
  }),
  readSharedTransformationContext: makeMethodDescriptor({
    aliases: ['shared_transformation_context_read'],
    description: 'Read only the shared transformation summary across widgets.',
    returns: {
      kind: 'sharedTransformationContext',
      description: 'A stable shared transformation-context projection derived from the current workspace state.',
      schema: { type: 'object', additionalProperties: true },
    },
  }),
  readActiveAnalyticalContext: makeMethodDescriptor({
    aliases: ['active_analytical_context_read'],
    description: 'Read the compact summary of which shared analytical contexts are currently active.',
    returns: {
      kind: 'activeAnalyticalContext',
      description: 'A compact shared analytical-context summary derived from the current workspace state.',
      schema: { type: 'object', additionalProperties: true },
    },
  }),
