(() => {
  ...
  return {
    ...
    title: 'Shared Source: Visitors by Region',
    width: 620,
    height: 340,
    ...
    encoding: {
      ...
      tooltip: [
        ...
        { field: 'marketing_spend', type: 'quantitative', aggregate: 'sum', format: ',' },
        { field: 'education_events', type: 'quantitative', aggregate: 'sum' },
      ],
    },
    config: {
      view: { stroke: null },
