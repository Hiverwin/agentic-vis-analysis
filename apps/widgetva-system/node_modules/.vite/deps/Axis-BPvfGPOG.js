...
import { An as defaults, At as quadraticSubdivide, Bn as isArray, Bt as Point, Cn as __extends$1, Ct as cubicDerivativeAt, D as Displayable, Dn as concatArray, Dt as quadraticAt, En as clone$1, Et as cubicSubdivide, F as Group, Fn as filter, Gt as invert, H as copyTransform, Hn as isDom, Ht as copy, I as calculateTextPosition, Jn as isRegExp, Kn as isNumber, L as getBoundingRect, Ln as hasOwn, M as registerPainter, Mn as each$2, Mt as sort, N as registerSSRDataGetter, Nn as eqNaN, Nt as BoundingRect, On as createHashMap, Ot as quadraticDerivativeAt, Pn as extend, Qn as keys, Rn as indexOf, St as cubicAt, Tn as bind, Un as isFunction, Ut as create, V as Transformable, Vn as isArrayLike, Wt as identity, Xn as isStringSafe, Yn as isString, Zn as isTypedArray, _n as normalize, _r as setPlatformAPI, an as add, ar as normalizeCssArray$1, b as windingLine, bt as LRU, c as CompoundPath, cr as retrieve2, dr as slice, er as map$1, f as Rect, fn as distance, fr as trim, g as ZRImage, gn as min, gr as platformApi, gt as modifyHSL, h as subPixelOptimizeRect$1, hn as max, in as Eventful, ir as noop, j as init$1, kn as curry, l as ZRText, lr as retrieve3, m as subPixelOptimizeLine$1, mt as liftColor, on as applyTransform$1, or as reduce, p as subPixelOptimize$1, qn as isObject$2, qt as mul, r as brushSingle, rr as mixin, sn as clone, tn as encodeHTML, tr as merge, ur as setAsPrimitive, vn as scale, vr as env, w as PathProxy, wn as assert, xn as sub, y as Path, z as parsePercent$1, zn as inherits, zt as createIntersectContext } from "./graphic-Byb0a---.js";
	...
	overallReset: function(ecModel) {
		...
		ecModel.eachSeries(function(seriesModel) {
			if (!seriesModel.isColorBySeries()) {
				...
				inner$1(seriesModel).scope = paletteScopeGroupByType.get(key) || paletteScopeGroupByType.set(key, {});
			}
		});
		ecModel.eachSeries(function(seriesModel) {
...
//#endregion
export { initLinearScaleMapper as $, mathMin$2 as $a, clearTmpModel as $i, normalizeCssArray as $n, traverseElements as $r, ChartView as $t, isAxisOnBand as A, error as Aa, enterEmphasis as Ai, box as An, ensureCopyRect as Ar, registerPreprocessor as At, IntervalScale as B, getPercentWithPrecision as Ba, COMPONENT_MAIN_TYPE_SERIES as Bi, sizeCalculable as Bn, isBoundingRectAxisAligned as Br, normalizeSymbolOffset as Bt, requireAxisStatistics as C, queryDataIndex as Ca, createFromString as Ci, registerInternalOptionCreator as Cn, XY as Cr, registerCoordinateSystem as Ct, getAxisRawValue as D, validateUpstreamOutputRange as Da, enableHoverEmphasis as Di, ComponentModel as Dn, clipRectByRect as Dr, registerMap as Dt, determineAxisType as E, unionExtentFromNumber as Ea, enableComponentHighDownFeatures as Ei, tokens as En, clipPointsByRect as Er, registerLoading as Et, shouldAxisShow as F, MAX_SAFE_INTEGER as Fa, setDefaultStateProxy as Fi, getCircleLayout as Fn, getCurrentCanvasPainter as Fr, registerVisual as Ft, intervalScaleEnsureValidExtent as G, isNumeric as Ga, SOURCE_FORMAT_ORIGINAL as Gi, simpleCoordSysInjectionProvider as Gn, payloadDisableAnimation as Gr, findEventDispatcher as Gt, ensureValidSplitNumber as H, getPrecision as Ha, SERIES_LAYOUT_BY_COLUMN as Hi, decideCoordSysUsageKind as Hn, makeImage as Hr, symbolBuildProxies as Ht, shouldShowAllLabels as I, addSafe as Ia, setStatesFlag as Ii, getLayoutParams as In, getShapeClass as Ir, setCanvasCreator as It, isOrdinalScale as J, linearMap as Ja, setCommonECData as Ji, convertToColorString as Jn, retrieveZInfo as Jr, getVisualFromData as Jt, isIntervalOrLogScale as K, isPositionSizeOptionPercent as Ka, UNDEFINED_STR as Ki, addCommas as Kn, registerShape as Kr, createLegacyDataSelectAction as Kt, updateIntervalOrLogScaleForNiceOrAligned as L, asc as La, setStatesStylesFromModel as Li, getLayoutRect as Ln, getTransform as Lr, version as Lt, isOnAxisZeroDiscouraged as M, makePrintable as Ma, leaveBlur as Mi, createBoxLayoutReference as Mn, expandOrShrinkRect as Mr, registerTheme as Mt, makeLabelFormatter as N, throwError as Na, leaveEmphasis as Ni, fetchLayoutMode as Nn, extendPath as Nr, registerTransform as Nt, getScaleValuePositionKind as O, deprecateLog as Oa, enableHoverFocus as Oi, LOCATION_PARAMS as On, createIcon as Or, registerPostInit as Ot, retrieveAxisBreaksOption as P, warn as Pa, setAsHighDownDispatcher as Pi, getBoxLayoutParams as Pn, extendShape as Pr, registerUpdateLifecycle as Pt, getScaleExtentForMappingUnsafe as Q, mathMax$2 as Qa, SINGLE_REFERRING as Qi, getTooltipMarker as Qn, transformDirection as Qr, throttle as Qt, AXIS_TYPES as R, getAcceptableTickPrecision as Ra, toggleHoverEmphasis as Ri, mergeLayoutParam as Rn, graphic_exports as Rr, createOrUpdatePatternFromDecal as Rt, registerMetricImpl as S, preparePipelineContext as Sa, clonePath as Si, getDecalFromPalette as Sn, WH as Sr, registerAction as St, createScaleByModel as T, removeDuplicates as Ta, SPECIAL_STATES as Ti, makeSeriesEncodeForNameBased as Tn, calcZ2Range as Tr, registerLayout as Tt, getIntervalPrecision as U, getPrecisionSafe as Ua, SOURCE_FORMAT_ARRAY_ROWS as Ui, injectCoordSysByOption as Un, makePath as Ur, getCachePerECPrepare as Ut, OrdinalScale as V, getPixelPrecision as Va, ROAM_ACTION_TYPE_SUFFIX as Vi, CoordinateSystemManager as Vn, linePolygonIntersect as Vr, normalizeSymbolSize as Vt, increaseInterval as W, isNullableNumberFinite as Wa, SOURCE_FORMAT_OBJECT_ROWS as Wi, registerLayOutOnCoordSysUsage as Wn, mergePath as Wr, getCustomSeries as Wt, decorateScaleMapper as X, mathCeil as Xa, ListIterator as Xi, formatTpl as Xn, subPixelOptimize as Xr, clear as Xt, isTimeScale as Y, mathAbs$2 as Ya, makeStyleMapper as Yi, formatTime as Yn, setTooltipConfig as Yr, setItemVisualFromData as Yt, enableScaleMapperFreeze as Z, mathFloor as Za, MULTIPLE_REFERRING as Zi, formatTplSimple as Zn, subPixelOptimizeLine as Zr, createOrUpdate as Zt, associateSeriesWithAxis as _, makeQueryConditionKindA as _a, Polygon as _i, passesSanitizationFilter as _n, getFont as _r, getCoordinateSystemDimensions as _t, parseGeoJSON as a, ensureExtentAscSimply as aa, removeElement as ai, TooltipMarkupStyleCreator as an, parsePercent as ao, getScaleBreakHelper as ar, prepareSeriesDataSchema as at, eachSeriesDealForAxisStat as b, parseFinder as ba, Ellipse as bi, retrieveRawValue as bn, setLabelStyle as br, getMap as bt, contain as c, getTooltipRenderMode as ca, updateProps as ci, getPaddingFromTooltipModel as cn, quantity as co, getLocaleModel as cr, getDimensionTypeByAxis as ct, scaleCalcNice2 as d, interpolateRawValues as da, RadialGradient as di, disableTransformOptionMerge as dn, remRadian as do, inheritDefaultOption as dr, connect as dt, compressBatches as ea, traverseUpdateZ as ei, createRenderPlanner as en, mathPI as eo, toCamelCase as er, OrdinalMeta as et, scaleCalcNiceDirectly as f, isNameSpecified as fa, LinearGradient as fi, SortOrderComparator as fn, round as fo, Model as fr, dataTool as ft, scaleRawExtentInfoEnableBoxCoordSysUsage as g, makeInternalComponentId as ga, Polyline as gi, parseSanitizationFilter as gn, createTextStyle as gr, dispose as gt, scaleRawExtentInfoCreate as h, makeInner as ha, Line as hi, parseDataValue as hn, createTextConfig as hr, disconnect as ht, createAxisLabelsComputingContext as i, defaultEmphasis as ia, isElementRemoved as ii, defaultSeriesFormatTooltip as in, parseDate as io, roundTime as ir, createDimensions as it, isNameLocationCenter as j, log as ja, isHighDownDispatcher as ji, copyLayoutParams as jn, ensureCopyTransform as jr, registerProcessor as jt, getTickValueOutermost as k, deprecateReplaceLog as ka, enterBlur as ki, applyPreserveAspect as kn, decomposeTransform as kr, registerPostUpdate as kt, use as l, groupData as la, IncrementalDisplayable as li, retrieveVisualColorForTooltipMarker as ln, quantityExponent as lo, registerLocale as lr, DataDiffer as lt, registerAxisContainShapeHandler as m, makeCallOnlyOnce as ma, BezierCurve as mi, getRawValueParser as mn, __extends as mo, animateLabelValue as mr, disConnect as mt, calcBandWidth as n, createSimpleOverallStageHandler as na, getOldStyle as ni, SERIES_UNIVERSAL_TRANSITION_PROP as nn, nice as no, getTextRect as nr, getStackedDimension as nt, GeoJSONRegion as o, getDataItemValue as oa, removeElementWithFadeOut as oi, buildTooltipMarkup as on, parsePositionSizeOption as oo, hasBreaks as or, SeriesData as ot, adoptScaleRawExtentInfoAndPrepare as p, isValidBoundsForExtent as pa, Arc as pi, createFilterComparator as pn, roundLegacy as po, LabelMarginType as pr, dependencies as pt, isLogScale as q, isRadianAroundZero as qa, getECData as qi, capitalFirst as qn, resizePath as qr, getItemVisualFromData as qt, AxisTickLabelComputingKind as r, createSimpleOverallStageHandler2 as ra, initProps as ri, SeriesModel as rn, numericToNumber as ro, format as rr, isDimensionStacked as rt, GeoSVGRegion as s, getIncrementalId as sa, saveOldStyle as si, createTooltipMarkup as sn, quantile as so, registerScaleBreakHelperImpl as sr, createDimNameMap as st, Axis as t, convertOptionIdName as ta, getAnimationConfig as ti, ComponentView as tn, mathRound as to, windowOpen as tr, enableDataStack as tt, scaleCalcNice as u, initExtentForUnion as ua, OrientedBoundingRect as ui, SourceManager as un, reformIntervals as uo, getUID as ur, PRIORITY as ut, countSeriesOnAxisOnKey as v, mappingToExists as va, Ring as vi, DataFormatMixin as vn, getLabelStatesModels as vr, getInstanceByDom as vt, AxisModelCommonMixin as w, queryReferringComponents as wa, DISPLAY_STATES as wi, makeSeriesEncodeForAxisCoordSys as wn, applyTransform as wr, registerCustomSeries as wt, eachSeriesOnAxisOnKey as x, preParseFinder as xa, Circle as xi, createSourceFromSeriesDataOption as xn, setLabelValueAnimation as xr, init as xt, eachAxisOnKey as y, normalizeToArray as ya, Sector as yi, normalizeTooltipFormatResult as yn, labelInner as yr, getInstanceById as yt, LogScale as z, getPercentSeats as za, getViewOfComponentOrSeries as zi, positionElement as zn, groupTransition as zr, createSymbol as zt };

//# sourceMappingURL=Axis-BPvfGPOG.js.map