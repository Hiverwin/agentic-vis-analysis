...
export function createDefaultWidgetVAHostBridge() {
  ...
  return {
    ...
    readWorkspaceAnnotations: emptyArray,
    ...
    setWorkspaceAnnotations: undefined,
    addWorkspaceAnnotation: undefined,
    clearWorkspaceAnnotations: undefined,
...
export function createWidgetVAHostBridge(options = {}) {
  ...
  return {
    ...
    readWorkspaceAnnotations: () => selectValue(selectors, 'readWorkspaceAnnotations', readState, (state) => state?.workspaceAnnotations || []) || [],
    ...
    setFocusedWidgetRef: typeof resolveAction(actions, 'setFocusedWidgetRef', initialState?.setCurrentFocusedWidgetRef) === 'function'
      ...
      : undefined,
    setWorkspaceAnnotations: typeof resolveAction(actions, 'setWorkspaceAnnotations', initialState?.setWorkspaceAnnotations) === 'function'
      ? (annotations) => invokeResolvedAction(actions, 'setWorkspaceAnnotations', readState, 'setWorkspaceAnnotations', [annotations])
      : undefined,
    addWorkspaceAnnotation: typeof resolveAction(actions, 'addWorkspaceAnnotation', initialState?.addWorkspaceAnnotation) === 'function'
      ? (annotation) => invokeResolvedAction(actions, 'addWorkspaceAnnotation', readState, 'addWorkspaceAnnotation', [annotation])
      : undefined,
    clearWorkspaceAnnotations: typeof resolveAction(actions, 'clearWorkspaceAnnotations', initialState?.clearWorkspaceAnnotations) === 'function'
      ? () => invokeResolvedAction(actions, 'clearWorkspaceAnnotations', readState, 'clearWorkspaceAnnotations')
      : undefined,
